...
class simulador(object):
    ...
    def crear_datos_simulador(self):
        ...
        toc_1 = "TOC,01," + "%.2f" % (random.randint(0, 254) + random.random()) + ","
        toc_1 += "%.2f" % (random.randint(0, 254) + random.random()) + ","
        toc_1 += "%d" % random.randint(0, 100) + ","
        toc_1 += "%d" % random.randint(0, 100) + ","
        toc_1 += "%d" % random.randint(0, 1) + ","
        toc_1 += "%d" % random.randint(0, 1) + ","
        toc_1 += "%d" % random.randint(0, 60) + ","
        toc_1 += "%d" % random.randint(0, 255) + ","
        toc_1 += "%d" % random.randint(0, 1000)

        # Biodigestor bioetanol
        
        toc_2 = "TOC,02," + "%d" % (random.randint(0,1000)) + ","
        toc_2 += "%d" % (random.randint(0, 1000)) + ","
        toc_2 += "%d" % (random.randint(0, 1000)) + ","
        toc_2 += "%.2f" % (random.randint(0,255) + random.random()) + ","
        toc_2 += "%.2f" % (random.randint(0,255) + random.random()) + ","
        toc_2 += "%.2f" % (random.randint(0,255) + random.random()) + ","
        toc_2 += "%d" % (random.randint(0,100)) + ","
        toc_2 += "%d" % (random.randint(0,100)) + ","
        toc_2 += "%d" % (random.randint(0,1))

        # Reactor Biodiesel

        toc_3 = "TOC,03," + "%.2f" % (random.randint(0,255) + random.random()) + ","
        toc_3 += "%d" % (random.randint(0, 1)) + ","
        toc_3 += "%d" % (random.randint(0, 1)) + ","
        toc_3 += "%d" % (random.randint(0, 1)) + ","
        toc_3 += "%d" % (random.randint(0, 255)) + ","
        toc_3 += "%d" % (random.randint(0, 1)) + ","
        toc_3 += "%d" % (random.randint(0, 255)) + ","
        toc_3 += "%d" % (random.randint(0, 255)) + ","
        toc_3 += "%d" % (random.randint(0, 1)) + ","
        ...
        toc_4 = "TOC,04," + "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_4 += "%.2f" % (random.randint(0,255) + random.random()) + ","
        toc_4 += "%.2f" % (random.randint(0,255) + random.random()) + ","
        toc_4 += "%.2f" % (random.randint(0,255) + random.random()) + ","
        ...
        toc_5 = "TOC,05," + "%.2f" % (random.randint(0, 254) + random.random()) + ","
        toc_5 += "%d" % (random.randint(0, 255)) + ","
        toc_5 += "%d" % (random.randint(0, 255)) + ","
        toc_5 += "%d" % (random.randint(0, 2000))

        # Generador magnetico
        
        toc_6 = "TOC,06," + "%d" % (random.randint(0,255)) + ","
        toc_6 += "%d" % (random.randint(0,255)) + ","
        toc_6 += "%d" % (random.randint(0,2500))

        # Generador calentador Stirling

        toc_7 = "TOC,07," + "%.2f" % (random.randint(0,500) + random.random()) + ","
        toc_7 += "%.2f" % (random.randint(0,255) + random.random()) + ","
        toc_7 += "%d" % (random.randint(0,2500)) + ","
        toc_7 += "%.2f" % (random.randint(0,1000) + random.random())
        ...
        toc_9 += "%d" % (random.randint(0, 100)) + ","
        toc_9 += "%.2f" % (random.randint(0, 255) + random.random())
        ...
        toc_10 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_10 += "%.2f" % (random.randint(0, 14) + random.random()) + ","
        toc_10 += "%d" % (random.randint(0, 1)) + ","
        toc_10 += "%d" % (random.randint(0, 255)) + ","
        toc_10 += "%d" % (random.randint(0, 1)) + ","
        toc_10 += "%d" % (random.randint(0, 255)) + ","
        toc_10 += "%d" % (random.randint(0, 1)) + ","
        toc_10 += "%d" % (random.randint(0, 255)) + ","
        ...
        toc_11 = "TOC,11,"
        toc_11 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_11 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_11 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_11 += "%d" % (random.randint(0, 20))

        # Condensador atmosferico

        toc_12 = "TOC,12,"
        toc_12 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_12 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_12 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_12 += "%d" % (random.randint(0, 100)) + ","
        ...
        toc_15 = "TOC,15,"
        toc_15 += "%d" % (random.randint(0, 1000)) + ","
        toc_15 += "%d" % (random.randint(0, 1000)) + ","
        toc_15 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_15 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_15 += "%.2f" % (random.randint(0, 255) + random.random()) + ","
        toc_15 += "%.2f" % (random.randint(0, 255) + random.random())
