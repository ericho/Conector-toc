...
class gui(object):
    ...
    def llenar_campos_modelo(self):
        ...
        self.mod13_nivel_1 = self.treestore.append(self.modulo_13, ['Cisterna AP', '--'])
        self.mod13_nivel_2 = self.treestore.append(self.modulo_13, ['Tinaco AP', '--'])
        self.mod13_nivel_3 = self.treestore.append(self.modulo_13, ['Cisterna ALl', '--'])
        self.mod13_nivel_4 = self.treestore.append(self.modulo_13, ['Tinaco ALl', '--'])
        self.mod13_nivel_5 = self.treestore.append(self.modulo_13, ['Tinaco AJ', '--'])
        self.mod13_nivel_6 = self.treestore.append(self.modulo_13, ['Cisterna AJ', '--'])
        self.mod13_bomba_1 = self.treestore.append(self.modulo_13, ['Bomba AJ', '--'])
        self.mod13_bomba_2 = self.treestore.append(self.modulo_13, ['Bomba ALl', '--'])
