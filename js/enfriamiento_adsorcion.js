...
function llenarPestanasDeck(){
    var html = "<div id='tabla_datos_reciente'></div><div width='100%' height:'250'><canvas id='termo_agua_fria' width='80' height='250' style='float:left'></canvas><canvas id='termo_agua_caliente' width='80' height='250' style='float:left'></canvas><canvas id='termo_sal_caliente' width='80' height='250' style='float:left'></canvas><canvas id='termo_tuberia' width='80' height='250' style='float:left'></canvas><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><canvas id='presion_1' width='200px' height='200px' style='float:left'></canvas><canvas id='presion_domo' width='200px' height='200px' style='float:left'></canvas><canvas id='presion_tuberia' width='200px' height='200px' style='float:left'></canvas></div><div id='2tabla_datos_reciente' style='float:left; width:auto; padding-left:10px;'></div>";
